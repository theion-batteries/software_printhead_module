...
parser.add_argument('--c', '--coordinates', help='coordinates for quadrilateral like: topleftx toplefty bottomleftx bottomlefty bottomrightx bottomrighty toprightx toprighty', nargs=8, required=True)
...
msg['cmd'] = "PrintOnDemandFastMaskReq"
msg['sn'] = args.sn
msg['topleftx'] = args.coords[0]
msg['toplefty'] = args.coords[1]
msg['bottomleftx'] = args.coords[2]
msg['bottomlefty'] = args.coords[3]
msg['bottomrightx'] = args.coords[4]
msg['bottomrighty'] = args.coords[5]
msg['toprightx'] = args.coords[6]
msg['toprighty'] = args.coords[7]
...
#
print("### MRA_PrintOnDemandFastMask.py finished")
