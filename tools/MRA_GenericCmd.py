...
parser.add_argument('--cmd', type=str, default="QueryApiReq")
parser.add_argument('--sn', type=str, default="1")
parser.add_argument('--jobid', type=str, default="")
parser.add_argument('--operate', type=str, default="")
...
#
print("### MRA_GenericCmd.py finished")
